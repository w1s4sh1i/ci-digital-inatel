...
module i2c_slave_tb;
    ...
    initial begin
        ...
        for (i = 7; i >= 0; i = i - 1) begin
			...
			wait (uut.state == 3'b010 || negedge_detected);
        ...
        @(negedge scl) sda_in = 1'b0;
        @(posedge scl) #20 sda_in = 1'b1;
		...
		master_address[0] = 1'b1; // Configurar bit R/W para leitura
