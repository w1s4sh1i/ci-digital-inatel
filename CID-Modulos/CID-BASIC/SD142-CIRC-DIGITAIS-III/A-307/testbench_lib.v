...
module stimulus_from_file #(
    parameter	FILE_NAME = "stimulus.hex",           // File to read
    			...
    			DEPTH = 8                             // Number of memory locations
)(
...
// 2 - Salvar dados arquivo externo 

module save_result_to_file #(
    parameter	FILE_NAME = "result.txt",             // File to save
    			RADIX = "bin",                        // Save data radix: bin, dec, hex, oct           
    			DATA_WIDTH = 8                        // Width of data
)(
    input                       clk, enable, save,  // Flag to end writing and save file
