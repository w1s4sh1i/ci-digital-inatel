...
:white_check_mark: Multiplicando = 14 e Multiplicador = 12;

:white_check_mark: Descrever em Verilog o multiplicador shift-and-add para N bits e simule para N = 4. Nesse caso, K = 1 quando o contador chegar ao estado 112.

:white_check_mark: Desenvolver um testbench e simular seu código fonte para realizar a multiplicação entre 1101 e 1011.
